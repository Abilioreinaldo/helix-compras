...
class AprovarEtapaAction
{
    ...
    private function aprovadoresElegiveis(Requisicao $requisicao, string $nivel): Collection
    {
        ...
        // `tenant_user`, não `users.tenant_id` (tenant HOME da identidade). O filtro do
        // pivot `unidade_user` continua por cima — ele diz QUEM aprova aquela unidade
        // naquele nível —, mas sozinho ele notificaria também o ex-membro cujo vínculo
        // com a empresa já foi revogado e cuja linha de unidade ficou para trás.
