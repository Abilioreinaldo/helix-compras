<div class="flex min-h-screen flex-col lg:flex-row">
    ...
    <div class="hidden flex-col justify-center gap-8 p-12 lg:flex lg:w-1/2 xl:p-16">
        <div class="flex items-center gap-3">
            <x-helix-logo class="h-11 w-11" />
            <span class="text-lg font-bold tracking-[0.2em] text-white">HELIX <span class="font-medium tracking-normal text-slate-400">Compras</span></span>
        </div>

        <div>
            <h1 class="text-4xl font-bold leading-tight tracking-tight text-white xl:text-5xl">
                Gestão Inteligente de<br><span class="bg-gradient-to-r from-blue-400 via-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Compras Corporativas</span>
            </h1>
        ...
        <ul class="space-y-2.5">
            @foreach (['Gestão multiunidade centralizada', 'Aprovação por alçada multinível', 'Trilha de auditoria completa'] as $feature)
                <li class="flex items-center gap-2.5 text-slate-200">
                    <span class="flex h-5 w-5 items-center justify-center rounded-full bg-fuchsia-500/15 text-fuchsia-300">
            ...
            <svg viewBox="0 0 560 64" class="w-full max-w-lg" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="fluxo-conn" x1="0" y1="0" x2="1" y2="0">
                        <stop offset="0%" stop-color="#2563eb" /><stop offset="100%" stop-color="#a855f7" />
                    </linearGradient>
                </defs>
        ...
        <div class="grid max-w-lg grid-cols-2 gap-4">
            @php
                $cards = [
                    ...
                    ['icon' => 'dollar', 'valor' => 'R$ 1.248.750', 'label' => 'Economia gerada (+18,6%)', 'accent' => 'text-fuchsia-300'],
                    ['icon' => 'document', 'valor' => '134', 'label' => 'Contratos ativos', 'accent' => 'text-blue-300'],
                    ['icon' => 'check-badge', 'valor' => '100%', 'label' => 'Conformidade', 'accent' => 'text-fuchsia-300'],
                ];
            @endphp
    ...
    <div class="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div class="w-full max-w-md rounded-2xl border border-blue-500/20 bg-slate-900/80 p-8 shadow-[0_8px_32px_rgba(59,130,246,0.15)] backdrop-blur-xl">
            ...
            <div class="mb-6 flex flex-col items-center text-center lg:items-start lg:text-left">
                <x-helix-logo class="mb-3 h-12 w-12 lg:hidden" />
            ...
            <form wire:submit="autenticar" novalidate>
                ...
                <button type="submit"
                    class="w-full rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_0_20px_rgba(124,58,237,0.35)] transition duration-300 hover:from-blue-700 hover:to-purple-700 hover:shadow-[0_0_30px_rgba(124,58,237,0.6)]">
                    Entrar
                </button>
            </form>
            ...
            <p class="mt-6 text-center text-sm text-slate-400">
                Precisa de acesso? <a href="#" class="font-medium text-fuchsia-400 hover:text-fuchsia-300">Fale com um especialista</a>
            </p>
        </div>
    </div>
</div>
