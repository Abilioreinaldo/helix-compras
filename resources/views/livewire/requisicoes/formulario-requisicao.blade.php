            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="flex items-center gap-6 pt-5">
                    <label class="flex items-center gap-2 text-sm text-slate-300 cursor-pointer">
                        <input type="checkbox" wire:model="urgente" class="rounded border-slate-700 bg-slate-800 text-blue-600">
                        Urgente
                    </label>
                    <label class="flex items-center gap-2 text-sm text-slate-300 cursor-pointer">
                        <input type="checkbox" wire:model.live="isEmergencial" class="rounded border-slate-700 bg-slate-800 text-blue-600">
                        Emergencial
                    </label>
                </div>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-3">
                @foreach ($itens as $idx => $item)
                    <div wire:key="item-{{ $idx }}" class="rounded-lg border border-slate-800 bg-slate-950/40 p-4 space-y-3">
    ...
    <div class="flex items-center justify-between gap-3 pt-2">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('requisicoes.index') }}"
                class="rounded-lg border border-slate-700 bg-slate-800 px-4 py-2 text-sm font-medium text-slate-200 hover:bg-slate-700 transition-colors">
                Voltar
            </a>
